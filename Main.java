...
public class Main {
            ...
            if (input == 1) { // Go North
                ...
                if (newSpot == 'x') {
                    ...
                    if (player.hasKey() == true) { // if character has the key, they can proceed
                        ...
                        System.out.print("However, it seems you haven't found the key."); // if the player has no
                                                                                          // key,
                ...
                if (newSpot == 'x') {
                    ...
                    System.out.print("You find a locked gate. "); // Go to gate to get to the next level/end the
                                                                  // game
                    if (player.hasKey() == true) {
                        ...
                        System.out.print("However, it seems you haven't found the key.");
                        // if player doesn't have the
                        // key, then he can't proceed
                        // to the next level/end the
                        // game
                    }
                } else if (newSpot == 'i') {
                    if ((int) Math.round(Math.random() * 1) == 0) { // Determines whether the user finds a potion or
                                                                    // key
                        System.out.println("You found a potion!");
                ...
                if (newSpot == 'x') {
                    ...
                    System.out.println("You find a locked gate. "); // Go to gate to get to the next level/end the
                                                                    // game
                    if (player.hasKey() == true) {
    ...
    public static boolean monsterRoom(Hero h, Enemy e) {
        ...
        while (valid) {
            ...
            if (input == 1) { // Fight Option
                ...
                // when running awa from an enemy, gives a random
                // direction to run
                if (randDir == 0) {
                    h.goNorth();
                    valid = false;
    ...
    /*
     * A single round of attack where the user has multiple options of attacking. If
     * the enemy is still alive, it will attack back
     * 
     * @param e, the enemy generated for the encounter
     * 
     * @param h, player
        ...
        while (valid) {
            ...
            if (input == 1) { // Potion Option
                if (h.getGold() >= 25) {
                    ...
                    System.out.println(
                            "Tt seems you don't have enough coin, come back when you're a little... mmmm... richer");
                }
                ...
                if (h.getGold() >= 0) {
                    ...
                    System.out.println(
                            "It seems you don't have enough coin, come back when you're a little... mmmm... richer");
                }
            } else { // Exit
                valid = false;
            }

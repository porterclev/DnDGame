...
/*  
Leaves a reveal on the place the hero is to track where he has been, then moves the hero north
...
/*  
Leaves a reveal on the place the hero is to track where he has been, then moves the hero south
@return The hero's location upon moving
*/
  public char goSouth(){
    PlayableMap.getInstance().reveal(loc);
...
/*  
Leaves a reveal on the place the hero is to track where he has been, then moves the hero east
@return The hero's location upon moving
*/
  public char goEast(){
    PlayableMap.getInstance().reveal(loc);
...
/*  
Leaves a reveal on the place the hero is to track where he has been, then moves the hero west
@return The hero's location upon moving
*/
  public char goWest(){
    PlayableMap.getInstance().reveal(loc);
  ...
  /**
   * attack calls the selected ability method that does random amount of damage to enemy
   * 
...
/*
Spends gold to pay for selected item. If the hero doesn't have the required amount of money, the the transaction doesn't go through
...
*/
  public boolean spendGold(int g){
    if(gold - g > 0){ gold -= g; return true; }
    else{ return false; }      
  }
/*  
...
@return Using up a potion if they have a potion, returninf false if they don't
*/
